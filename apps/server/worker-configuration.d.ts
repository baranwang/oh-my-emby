/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/server/wrangler.jsonc apps/server/worker-configuration.d.ts` (hash: 6db2575938cc8b79e52d16b5306bb0a4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "TRUSTED_PROXIES">> {}
}
