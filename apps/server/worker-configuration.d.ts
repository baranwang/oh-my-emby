/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/server/wrangler.jsonc apps/server/worker-configuration.d.ts` (hash: 5394790e6cab1dca0289817e8b8230f0)
...
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./apps/server/src/platform/workers/index");
  }
